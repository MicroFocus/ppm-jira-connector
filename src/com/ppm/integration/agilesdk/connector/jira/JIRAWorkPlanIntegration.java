...
public class JIRAWorkPlanIntegration extends WorkPlanIntegration {
    ...
    @Override public List<Field> getMappingConfigurationFields(WorkPlanIntegrationContext context, ValueSet values) {
        ...
        List<Field> fields =
                Arrays.asList(new Field[] {new PlainText(JIRAConstants.KEY_USERNAME, "USERNAME", "admin", true),
                        ...
                        new DynamicDropdown(JIRAConstants.KEY_JIRA_PROJECT_NAME, "JIRA_PRPOJECT", true) {
                            ...
                            @Override public List<String> getDependencies() {
                                return Arrays
                                        .asList(new String[] {JIRAConstants.KEY_USERNAME, JIRAConstants.KEY_PASSWORD});
                            }
