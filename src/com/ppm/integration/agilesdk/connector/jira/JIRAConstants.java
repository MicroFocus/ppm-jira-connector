...
public class JIRAConstants {
	...
	public static final String ISSUES_IN_SPRINT_SUFFIX = API_VERSION_API_ROOT
			+ "search?expand=schema&jql=sprint!=null and issueType!=sub-task and project=";
	public static final String ISSUES_SUFFIX = API_VERSION_API_ROOT
			+ "search?expand=schema&jql=issueType!=sub-task and project=";
